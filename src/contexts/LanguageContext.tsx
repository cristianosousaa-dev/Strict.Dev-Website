...
const translations: Translations = {
  pt: {
    ...
    'contact.statement.title': 'Desenvolvimento Web',
    'contact.statement.highlight': 'Com Resultados Reais',
    'contact.statement.description': 'Criamos websites e aplicações web de alto desempenho para empresas de todas as dimensões. Soluções profissionais com foco em qualidade, performance e crescimento do seu negócio.',
    ...
    'contact.info.responseLabel': 'Tempo de Resposta',
    'contact.info.responseValue': 'Dentro de 24 horas',
    ...
    'contact.form.progress': 'Progresso do Formulário',
    ...
    'contact.form.subjectLabel': 'Título do Projeto *',
    'contact.form.subjectPlaceholder': 'Redesign de Website',
    'contact.form.message': 'Descrição do Projecto',
    'contact.form.messageLabel': 'Detalhes do Projeto *',
    ...
    'contact.form.sentButton': 'Mensagem Enviada',
    ...
    'contact.form.privacyNote': 'Ao submeter este formulário, concorda com a nossa política de privacidade. As suas informações são seguras e nunca partilhadas.',
  ...
  en: {
    ...
    'contact.statement.title': 'Web Development',
    'contact.statement.highlight': 'With Real Results',
    'contact.statement.description': 'We create high-performance websites and web applications for businesses of all sizes. Professional solutions focused on quality, performance and business growth.',
    ...
    'contact.form.subjectLabel': 'Project Title *',
    'contact.form.subjectPlaceholder': 'Website Redesign',
    ...
    'contact.form.sentButton': 'Message Sent',
    ...
    'contact.form.privacyNote': 'By submitting this form, you agree to our privacy policy. Your information is secure and will not be shared.',
